    ...
    sections: [
      {
        ...
        text: (
          <>
            도서부는 교내 도서관 관리를 담당하며, 재학생들의 도서대출 및 반납등 도서관 이용에 도움을
            주는 부서입니다. 도서부는 학생회내에서 가장 많은 봉사시간을 부여받기도 해요. 그리고
            방학기간 독서모임등 생활기록부 자율활동에 입력할 수 있는 내용들이 많습니다! 생활기록부에
            관심이 많은 학생은 꼭 지원하세요!
            <br />
      ...
      },
      {
        ...
        text: (
          <>
            우리 도서부에서는 책을 좋아하고 성실한 친구들을 기다리고 있어요. 그리고 책을 제자리에 잘
            정리할 수 있어야 하기때문에 꼼꼼하고 인내심 있는 친구들을 기다리고 있습니다.
            <br />
            <br />
            마지막으로, 도서부에서는 부원들과 함께 열심히 일하고 독서와 문화에 대한 관심을 기회를
            지속적으로 제공하려 노력하고 있습니다. 학교생활을 하며 지식과 교양을 쌓으며 더욱
            발전하는 친구들을 기다릴게요! 많이 지원해주세요!
          </>
        ),
      },
    ],
