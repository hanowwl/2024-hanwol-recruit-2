      ...
      list: [
        {
          ...
          answer: [
            "보통 점심시간에 로테이션을 돌며 활동을 합니다. 그리고 학기중 1회 신규도서등록, 연말에 장서점검을 1회 진행합니다.",
          ],
        },
        {
          question: "도서부만의 특징은 어떤것이 있나요?",
          answer: [
            "도서부는 유일하게 부장과 차장뿐만 아니라 모든 구성원의 생활기록부를 작성해주는 부서입니다. 또한 담당 선생님이 따로 있어 학업 및 기타 상담도 가능하며 케어를 많이 받습니다.",
          ],
        },
        {
          question: "도서부에 합격하기 위해 어떤점이 중요할까요?",
          answer: [
            "우선 도서부 합격을 하기 위해서 학교 도서관의 역할에 대해 알아보고 오시면 좋을 것 같습니다. 또한 본인 스스로 먼저 책에 대한 관심이 많으면 더 좋은 점수를 받을 수 있을 것 같습니다. 가장 중요한것은 도서부에 들어와서 열심히 하고 발전할 수 있는 태도가 중요해요!",
          ],
        },
      ],
    },
